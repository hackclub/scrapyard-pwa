...
export async function generateApplePass({ user }) {
  const template = new Template("eventTicket", {
    ...
    relevantDate: new Date('March 1, 2025 12:00:00 GMT-0600'),
  });
  ...
  pass.headerFields.add({
    key: "date",
    value: new Date('March 1, 2025 12:00:00 GMT-0600'),
  ...
  pass.relevantDate = new Date("3-1-2025");
