      ...
      {state == "transmit" && (
        <div className={"akaya"} style={{
          ...
          <div style={{
            ...
            <img src="https://scrapyard.hackclub.com/favicon.png" height="1px" style={{ width: "1px", opacity: 0 }} />
            <img src={"https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=" + encodeURIComponent("https://hack.af/" + data.split("/").reverse()[0]) + "&ecc=M&color=ffffff&bgcolor=337D78&format=svg"} height="1px" style={{ width: "1px", opacity: 0 }} />
          </div>
        </div>
      )}
      {state == "display" && (
